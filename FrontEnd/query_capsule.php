<?php
    ...
    class Query_Capsule
    {
        ...
        final protected function Translate(string $encoded, string $reference): string //Combines Normalize->FormatShortHand->Parse_All
        {
            return $this->Parse_All($this->FormatShortHand($this->Normalize($encoded), $reference));
        }

        final protected function Normalize(string $abnormal): string //removes line ends and places spaces instead
        {
