            ...
            for(let i = 0; i < series.length; i++){
				...
				if(favoriteSeries.indexOf(id) === -1){
					...
					<div class="card">
						<div class="overlay">
						<div class="addBtn">
						<span><i class="fa fa-list plan" onclick="ptw('${series[i].id}')"></i></span>
						<span><i class="material-icons watch" onclick="completed('${series[i].id}')">visibility</i></span>
						<span><i class="material-icons favorite" onclick="favorite('${series[i].id}')">favorite</i></span>
						</div>
						<div class="movie">
							<h2>${series[i].name}</h2>
